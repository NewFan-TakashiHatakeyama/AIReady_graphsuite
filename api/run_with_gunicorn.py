#!/usr/bin/env python
"""
Start GraphSuite API with Gunicorn.
"""
...
from config import DEFAULT_TIMEOUT, DEFAULT_WORKERS, get_env_value, global_args
...
def main():
    ...
    print("🚀 Starting GraphSuite API with Gunicorn")
    print(f"🔄 Worker management: Gunicorn (workers={global_args.workers})")
    print("🔍 Preloading app: Enabled")
    print("📝 Note: Using Gunicorn preload for worker startup")
    print("\n\n" + "=" * 80)
    ...
    class GunicornApp(BaseApplication):
        ...
        def load(self):
            ...
            from graphsuite_server import get_application
